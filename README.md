...
----------------------------------
No support for JOIN operations because I don't feel need for it.
Anyway you still can do it by executing your own custom SQL query.
...
-	Why no autogenerated column support?

	In my use-case, the featuer was not required.
